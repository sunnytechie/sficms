                    ...
                    <div class="card-body">
                        <div class="" v-show="scheduleShow">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" v-model="eventName" placeholder="Enter event or tag ... ">
                            </div>
                            <div class="form-group">
                                <label>Date <span class="text-danger">*</span></label>
                              <input type="datetime-local" class="form-control" ref="scheduleId">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-tabs-solid">
                            <li class="nav-item" v-for="(menu, index) in menus" :key="index" @click="selectedMenu(menu.name)">
                                <a class="nav-link " href="#solid-tab1" data-toggle="tab">{{ menu.name}}</a
                    >
                  </li>
                </ul>
