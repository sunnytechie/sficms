            ...
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-success">@if ($article->status) Approved @elseif (!$article->status)   <span class="text-danger ">Rejected </span>  @else <span class="text-warning ">Pending </span> @endif </td>
                        <td class="text-right">
