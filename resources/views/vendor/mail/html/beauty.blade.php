                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p20b"
                                                                    style="font-size: 0px">
                                                                    <amp-img
                                                                        src="https://rgglpe.stripocdn.email/content/guids/CABINET_6dea352009961ab641cfa8448ee3054e/images/14421630672392079.png"
                                                                        alt="Logo"
                                                                        style="display: block;font-size: 12px"
                                                                        width="60" title="Logo" height="63"></amp-img>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td width="560" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            role="presentation">
                                                            <tr>
                                                                <td align="left" class="es-p10t es-p40b">
                                                                    <p style="font-size: 16px">Dear Chidieber
                                                                        Chukwudi<br>Nkpor Umuoji Road, Anambra State
                                                                        NigeriaNkpor Umuoji Road, Anambra State
                                                                        NigeriaNkpor Umuoji Road,
                                                ...
                                                <tr>
                                                    <td width="600" align="left">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <p style="font-size: 10px">Sisters Fellowship
                                                                        International. All Rights Reserved.</p>
                                                                    <p style="font-size: 10px">Nkpor Umuoji Road,
