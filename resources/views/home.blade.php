        ...
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>APT0002</td>
                        <td><img width="28" height="28" src="assets/img/profiles/avatar-07.jpg" class="rounded-circle m-r-5" alt=""> Brandon  Stone</td>
                        <td>29</td>
                        <td>5 Dec 2020</td>
                        <td>10:00am-12:00am</td>
                        <td>Fever</td>
                    ...
                    <tr>
                        <td>APT0004</td>
                        <td><img width="28" height="28" src="assets/img/profiles/avatar-04.jpg" class="rounded-circle m-r-5" alt=""> Kyle Woodbury</td>
                        <td>23</td>
                        <td>19 Dec 2020</td>
                        <td>10:00am-12:00am</td>
                        <td>Diabeties</td>
                    ...
                    <tr>
                        <td>APT0005</td>
                        <td><img width="28" height="28" src="assets/img/profiles/avatar-05.jpg" class="rounded-circle m-r-5" alt=""> Marie Gallardo</td>
                        <td>55</td>
                        <td>15 Dec 2020</td>
                        <td>10:00am-12:00am</td>
                        <td>Cold</td>
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td><img width="28" height="28" src="assets/img/profiles/avatar-03.jpg" class="rounded-circle m-r-5" alt=""> Maurice Guz</td>
                                <td class="text-right">
                                    <a href="#" class="btn btn-sm btn-white text-success"><i class="far fa-eye mr-1"></i> View</a> 
                                </td>
                            </tr>
                            <tr>
                                <td><img width="28" height="28" src="assets/img/profiles/avatar-05.jpg" class="rounded-circle m-r-5" alt=""> Marie Gallardo</td>
